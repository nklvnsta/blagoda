...
PRODUCTS = [
    ...
    ("Ряженка Благода 2.5% 500мл пак.",              "pcs", 13.00,  14,  "Кефир и йогурты",      3),
    ("Сметана Благода 15% 200г стак.",               "pcs", 14.00,  21,  "Масло и сметана",      3),
    ("Сметана Благода 20% 500г пак.",                "pcs", 21.00,  21,  "Масло и сметана",      3),
    ("Творог Благода 9% 200г",                       "pcs", 19.50,  14,  "Творог",               3),
    ("Йогурт Благода 2.8% Клубника 150г стак.",      "pcs", 11.50,  21,  "Кефир и йогурты",      4),
    ("Йогурт Благода питьев 2.8% Персик 400мл пак.", "pcs", 17.00,  21,  "Кефир и йогурты",      3),
    ("Сыр Благода Российский 50%, кг",               "kg", 115.00,  60,  "Сыры",                 2),
    ("Сыр Благода Гауда 45%, кг",                    "kg", 106.00,  60,  "Сыры",                 1),
    ("Сыр Брынза Благода 250г",                      "pcs", 32.00,  45,  "Сыры",                 2),
    # Колбасные изделия
    ...
    # Полуфабрикаты
    ("Пельмени Классические 900г",                   "pcs", 54.00, 180,  "Полуфабрикаты",        2),
    ("Пельмени Куриные 450г",                        "pcs", 36.00, 180,  "Полуфабрикаты",        2),
    ("Вареники с картофелем 600г",                   "pcs", 30.00, 180,  "Полуфабрикаты",        2),
    ("Вареники с творогом 600г",                     "pcs", 32.00, 180,  "Полуфабрикаты",        1),
    ("Котлета куриная заморож, кг",                  "kg",  48.00, 180,  "Полуфабрикаты",        3),
    # Консервы
    ("Говядина тушеная ГОСТ 338г ж/б",               "pcs", 41.00, 730,  "Консервы",             1),
]
